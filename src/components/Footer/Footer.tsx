...
export default function Footer() {
  return <FooterWrapper id="hero">
     
  <Container>
    <Row className="flex_center">
    <Column xs={12} sm={12} md={10} className="footer_left">
  
            <p>© 2022 Mikaël  Freva<span>, Développeur Web</span></p>
      ...
      <Column xs={12} sm={12} md={2} className="footer_right">
